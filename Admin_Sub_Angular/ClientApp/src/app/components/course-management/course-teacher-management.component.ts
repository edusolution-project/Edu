...
@Component({
    selector: 'course-teacher-management',
  templateUrl: './course-teacher-management.component.html',
  styleUrls: ['./course-teacher-management.component.scss']
})
export class CourseTeacherManagementComponent implements OnInit, AfterViewInit {
  columns: any[] = [];
  rows: Course[] = [];
  rowsCache: Course[] = [];
  editedCourse: Course;
  ...
  chon(item) {
    console.log(item);
    this.router.navigate(['/course-teacher-config', item.courseID]);
  }
