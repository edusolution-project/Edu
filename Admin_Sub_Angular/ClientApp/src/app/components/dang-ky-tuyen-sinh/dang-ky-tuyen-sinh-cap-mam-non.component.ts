...
@Component({
  selector: 'dang-ky-tuyen-sinh-cap-mam-non',
  templateUrl: './dang-ky-tuyen-sinh-cap-mam-non.component.html'
})
export class DangKyTuyenSinhCapMamNonComponent implements OnInit {
