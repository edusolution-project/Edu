...
(function (factory) {
    ...
    $(function () {
        ...
        $(document).on("click", "." + pluginClassName + "-hidable", function (e) {
            $('.notifyjs-container').removeClass("notifyjs-container");
...
var showNotification = function (from, align, msg, type) {
...
var active = function (command, id) {
    var frm = window.myform;
    var ctrl = frm.querySelector("#ctrl");
    ...
    frm.action = ctrl.value + "/" + command
    frm.method = "POST";
    frm.submit();
}
function changeLang(langCode) {
    var url = "/setlang?langCode=" + langCode;
    $.ajax({
        url: url,
        method: "GET",
        success: function () {
...
var thatActive = function (_this, name) {
...
if ('serviceWorker' in navigator) {
    window.addEventListener('load', function () {
        navigator.serviceWorker.register('/Contents/js/ServiceNotification.js')
