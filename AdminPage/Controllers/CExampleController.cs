...
{
    [CusMenu(CModule = "CExample", Icon = "people",Name = "Quản lý bài tập",Type = "Mod")]
    public class CExampleController : Controller
    {
        private readonly SysAccountServices _sysUser;
        private readonly SysRoleServices _sysRoles;
        public CExampleController(IHttpContextAccessor httpContext)
        {
