...
namespace BaseAccess.Attribule
{
    public class AccessCtrlAttribute : Attribute
    {
        ...
        public AccessCtrlAttribute(string name, string type, int order) : this(name, type)
        {
            Order = order;
        }


        public AccessCtrlAttribute(string name, string type, bool isShow) : this(name, type)
        {
            IsShow = isShow;
        }
