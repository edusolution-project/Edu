...
var Render = (function () {
    ...
    var renderNewFeed = function (item, container, comment, init) {
        ...
        var el = document.getElementById("compact" + item.ID);
        el.innerHTML += ("<div>" +
            "<span class='item-new-feed__sender'>" + _sender + "</span> " +
            "<span class='item-new-feed__time'>" + formatDate(_time) + "</span>" +
            "</div>");
        el.innerHTML += "<div class='item-new-feed__title'>" + _title + "</div>";
        el.innerHTML += "<div class='item-new-feed__fullcontent d-none'>" + _content + "</input>";
        var _shortcontent = $('<div>', { "html": _content }).text();
    ...
    var renderFeedFull = function (id) {
        ...
        orgContent.append($("<div>", { "class": "title_row row" })
            ...
            .append($("<div>", { "class": "col-md-2 text-right" })
                .append($('<button>', { "data-id": _id, "class": "item-new-feed__reply btn-primary btn", "data-toggle": "modal", "data-target": "#new-feed__reply--popup", "data-original-title": "Gửi trả lời", "title": "Trả lời", "text": "Gửi trả lời", "onclick": "initReply()" })
    ...
    var renderComment = function (item, container) {
        ...
        var buttonAnnouce = $('<button>', { "data-id": item.ID, "class": "btn feed_annouce" + (item.FeedType == 1 ? " active" : ""), "data-original-title": "Đánh dấu thông báo", "title": "Đánh dấu thông báo", "onclick": "toggleAnnouncement(this, '" + item.ID + "')" })
            .append($("<i>", { "class": "fas fa-bullhorn" }));
