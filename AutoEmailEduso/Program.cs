    ...
    class Program
    {
        ...
        public static async Task SendWeeklyReport()
        {
            try
            {
                ...
                var currentTime =new DateTime(2021,03,15,08,30,00);
                ...
                {
                    //var percent = "";
                    if (center.Abbr.Contains("_qt"))//test truong Vinh Yen
                    {
                        ...
                        if (listTeacherHeader.Count() > 1)
                        {
                            foreach (var item in listTeacherHeader)
                            {
                                ...
                                var toAddress = isTest == true ? new List<string> { "k.chee.dinh@gmail.com" } : new List<string> { "k.chee.dinh@gmail.com" };
