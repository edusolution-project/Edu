"use strict";function Submit(n,t,i,r){var u=document.querySelector('form[name="'+n+'"]'),c=t==""||t==void 0||t==null?u.action:t,l=u.method,a=$(u).find(":required"),s=!1,o,f,e,h;if(a.each(function(){if($(this).val()==""||$(this).val()==null)return alert("Vui lòng điền đủ thông tin"),$(this).focus(),s=!0,!1}),s)return!1;if((i.toLowerCase()=="delete"||i.toLowerCase()=="publish"||i.toLowerCase=="unpublish")&&(o=u.querySelector('input[name="ArrID"]'),f=u.querySelectorAll('input[name="cid"]'),o!=null))for(e=0;f!=null&&f.length>0&&e<f.length;e++)f[e].checked&&(o.value+=o.value==""?f[e].value:","+f[e].value);$(u).find("input:disabled").removeAttr("disabled");h=new FormData(u);showLoading("Sending data ...");Ajax(c,l,h,!0).then(function(n){hideLoading();r!=void 0&&r(n)}).catch(function(n){hideLoading();alert("Có lỗi, vui lòng thực hiện lại");console.log(i,n)})}function Export(n,t){var e=document.querySelector('form[name="'+n+'"]'),o=e.querySelector('input[name="ArrID"]'),u=e.querySelectorAll('input[name="cid"]'),r,f,i,s;if(o!=null)for(i=0;u!=null&&u.length>0&&i<u.length;i++)u[i].checked&&(o.value+=o.value==""?u[i].value:","+u[i].value);for(r=e.querySelectorAll("input"),f="",i=0;i<r.length;i++)r[i].value!=null&&r[i].type!="checkbox"&&(f+=f==""?"?"+r[i].name+"="+r[i].value:"&"+r[i].name+"="+r[i].value);s=t+f;window.open(s,"_blank")}function Add(n){var e=document.querySelector(n.getAttribute("data-target")),i=e.querySelector("form"),f=i.querySelector('input[name="ID"]'),u,r,t;for(f!=null&&(f.value="0"),u=i.querySelectorAll("input"),t=0;t<u.length;t++)u[t].value="";for(r=i.querySelectorAll("select"),t=0;t<r.length;t++)r[t].value=$(r[t]).find("option:first").attr("value");$(i).find("input:disabled").removeAttr("disabled")}function Edit(n,t,i,r){var o=document.querySelector(r.getAttribute("data-target")),u=o.querySelector("form"),f=u.querySelector('input[name="ID"]'),e;f==null?(f="<input name='ID' type='hidden' value='"+n+"' />",u.innerHTML+=f):f.value=n;$(u).find("input[locked]").attr("disabled","disabled");e=new FormData(u);Ajax(t,"POST",e,!0).then(function(n){var f=JSON.parse(n),i,o,r,s,e,t;for($(u).find("input[type=file]").val(""),i=$(u).find("input[type!=file]"),t=0;t<i.length;t++)i[t].value=f.Data[i[t].name],$(i[t]).hasClass("hiddenDate")&&(o=$(i[t]).attr("id"),$(i[t]).prev().removeClass("hasDatepicker").val($.datepicker.formatDate("dd/mm/yy",new Date(f.Data[i[t].name]))).datepicker({changeMonth:!0,changeYear:!0,dateFormat:"dd/mm/yy",altField:"#"+o,altFormat:"yy-mm-dd"}));for(r=$(u).find("img.thumbnail"),t=0;t<r.length;t++)console.log(r[t].name),s=f.Data[r[t].name],s!=null?$(r[t]).show().attr("src",f.Data[r[t].name]):$(r[t]).hide();for(e=$(u).find("select"),t=0;t<e.length;t++)$(e[t]).val(f.Data[$(e[t]).attr("name")]+"")})}function ExcuteOnlyItem(n,t,i){var r=new FormData;r.append("ArrID",n);Ajax(t,"POST",r,!0).then(function(n){return i!=void 0&&i(n),console.log(n),!1})}function hideModal(){$(".modal").hide();$(".modal-backdrop").hide();$("body").removeClass("modal-open")}function ToggleStatus(n){var t=$(n).attr("onclick");t.indexOf("UnPublish")>0?$(n).attr("onclick",t.replace("UnPublish","Publish")):$(n).attr("onclick",t.replace("Publish","UnPublish"));$(n).toggleClass("btn-success").toggleClass("btn-danger")}function ToggleSwitch(n){var t=$(n).attr("onclick");t.indexOf("UnPublish")>0?$(n).attr("onclick",t.replace("UnPublish","Publish")):$(n).attr("onclick",t.replace("Publish","UnPublish"))}function toggleCollapse(n,t){var u="#"+t+" .modules-content:first",i,r;$(u).collapse("toggle");i=$(n).parent().parent().find(".fa-minus-square");r=$(n).parent().parent().find(".fa-caret-down");$(i).hasClass("fa-plus-square")?$(i).attr("data-original-title","Collapse"):$(i).attr("data-original-title","Expand");$(i).toggleClass("fa-plus-square");$(r).toggleClass("fa-caret-right")}function b64EncodeUnicode(n){return n==null||n==void 0||n==""?"":btoa(encodeURIComponent(n).replace(/%([0-9A-F]{2})/g,function(n,t){return String.fromCharCode("0x"+t)}))}function b64DecodeUnicode(n){return n==null||n==void 0||n==""?"":decodeURIComponent(atob(n).split("").map(function(n){return"%"+("00"+n.charCodeAt(0).toString(16)).slice(-2)}).join(""))}function showLoading(n){$("body > .loadingState").length>0||($("body").append($("<div>",{"class":"loadingState",style:"background: black;position: fixed;top: 0;left: 0;right: 0;bottom: 0;opacity: 0.9;z-index: 9999;"})),(n==null||n=="")&&(n="Đang xử lý..."),$("body > .loadingState").append($("<div>",{style:"padding:10px 30px; border-radius: 5px; background: #CCC; font-size:26px; position:absolute; left: calc(50% - 120px); top: 45%;"}).append($("<i>",{"class":"fas fa-spinner fa-spin"})).append(" "+n)))}function hideLoading(){$("body > .loadingState").remove()}function stopAllMedia(){$("video").each(function(){$(this)[0].pause()});$("audio").each(function(){$(this)[0].pause()})}function toggleAnnouncement(n,t){var i=1;$(n).hasClass("active")&&(i=0);$.ajax({type:"POST",url:_ToggleFeedTypeURL,data:{ID:t,FeedType:i},dataType:"json",success:function(n){n.Error!=null?alert(n):($("#"+t+" .fa-bullhorn").parent().toggleClass("active"),$("#compact"+t+" .fa-bullhorn").parent().toggleClass("active"))},error:function(n){console.log(n.responseText)}})}function cacheStatic(n){return n==""?"":n.startsWith("http")?n:static_resource_path+n+"?&format=jpg"}function cacheStatic(n,t){return n==""?"":n.startsWith("http")?n:static_resource_path+n+"?&format=jpg&w="+t}function cacheStatic(n,t,i,r){return n==null&&r!=null?cacheStatic(r,t):n.startsWith("http")?n:static_resource_path+n+"?w="+t+"&h="+i+"&mode=crop&format=jpg"}function tab_gonext(){stopAllMedia();var n=$(".tab-pane"),t=n.index($(".tab-pane.active"));t<n.length-1&&($(n[t]).removeClass("show active"),$(n[t+1]).addClass("show active"))}function tab_goback(){stopAllMedia();var n=$(".tab-pane"),t=n.index($(".tab-pane.active"));t>0&&($(n[t]).removeClass("show active"),$(n[t-1]).addClass("show active"))}function tab_go(n){if($("#pills-"+n).hasClass("active"))return!1;$(".tab-pane.active").removeClass("active show");$(".nav-link.active").removeClass("active");$("#pills-"+n).removeClass("active");$("#pills-"+n).addClass("active");$("#pills-part-"+n).addClass("active show")}function tab_scroll_active(){var n=$("#pills-tab .nav-item:eq(0)"),t=$("#pills-tab .nav-item .active").parent();$("#pills-tab").scrollTop(t.offset().top-n.offset().top)}function tab_set_active(n){var t=setTimeout(function(){var t=$("#pills-tab .nav-item:eq(0)"),i=$(n).parent();$("#pills-tab").scrollTop(i.offset().top-t.offset().top)},50)}function goNav(n){var t=$("#"+n),i=$(t).attr("data-part-id");tab_go(i);$(t).find("input:eq(0)").focus()}function toggle_tab_compact(){$("#pills-tab").toggleClass("compact")}function toggleAll(n,t){var i=$("#"+t),r=$(n).prop("checked");$(i).find("[name=cid]").prop("checked",r)}function setToggle(n){var t=$("#"+n);$(t).find("input[type=checkbox]:first").prop("checked",$(t).find("[name=cid]:not(:checked)").length===0)}function start(n){$(n).parent().removeClass("d-flex").hide();$("#check-student").removeClass("d-none");$("#finish").removeClass("d-none");countdown()}function countdown(){var i,u;clearTimeout(u);var r=$(".time-counter").text().trim(),t=parseInt(r.split(":")[0]),n=parseInt(r.split(":")[1]);if(n>0)n--;else if(t>0)t--,n=59;else{endtime();return}i=(t<10?"0"+t:t)+":"+(n<10?"0"+n:n);$(".time-counter").text(i);localStorage.setItem("Timer",i);u=setTimeout(function(){countdown()},1e3)}function endtime(){}function togglePanelWidth(n){var t=$(n).parent().parent().parent();t.hasClass("col-md-6")?(t.removeClass("col-md-6").addClass("col-md-2"),t.siblings().removeClass("col-md-6").addClass("col-md-10")):t.hasClass("col-md-4")?(t.removeClass("col-md-4").addClass("col-md-6"),t.siblings().removeClass("col-md-8").addClass("col-md-6")):(t.removeClass("col-md-2").addClass("col-md-4"),t.siblings().removeClass("col-md-10").addClass("col-md-8"))}var g_actions=["getlist","getdetails","create","delete","import","export"],Ajax=function(n,t,i,r){var u=new XMLHttpRequest;return new Promise(function(f,e){u.onreadystatechange=function(){u.readyState==4&&(u.status>=200&&u.status<300?f(u.response):e({status:u.status,statusText:u.statusText}))};u.open(t||"GET",n,r||!0);u.send(i)})},iconSuccess='<div class="notify-icon icon-success"><?xml version="1.0" encoding="iso-8859-1"?><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 50 50" style="enable-background:new 0 0 50 50;" xml:space="preserve"><circle style="fill:#25AE88;" cx="25" cy="25" r="25"/><polyline style="fill:none;stroke:#FFFFFF;stroke-width:2;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;" points="38,15 22,33 12,25 "/><\/svg><\/div>',iconError='<div class="notify-icon icon-error"><?xml version="1.0" encoding="iso-8859-1"?><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 50 50" style="enable-background:new 0 0 50 50;" xml:space="preserve"><circle style="fill:#D75A4A;" cx="25" cy="25" r="25"/><polyline style="fill:none;stroke:#FFFFFF;stroke-width:2;stroke-linecap:round;stroke-miterlimit:10;" points="16,34 25,25 34,16"/><polyline style="fill:none;stroke:#FFFFFF;stroke-width:2;stroke-linecap:round;stroke-miterlimit:10;" points="16,16 25,25 34,34"/><\/svg><\/div>',notification=function(n,t,i){(n==void 0||n==null)&&(n="success");var r=document.querySelectorAll(".notification");document.body.innerHTML+=n=="success"?r==null||r.length==0||r==void 0?"<div class='notification success' id='notification_0'>"+iconSuccess+" "+t+"<\/div>":"<div id='notification_"+r.length+"' class='notification success' style='top:"+(10+6*r.length)+"%'>"+iconSuccess+" "+t+"<\/div>":r==null||r.length==0||r==void 0?"<div class='notification error' id='notification_0'>"+iconError+" "+t+"<\/div>":"<div id='notification_"+r.length+"' class='notification error' style='top:"+(10+6*r.length)+"%'>"+iconError+" "+t+"<\/div>";setTimeout(function(){var n=document.getElementById("notification_"+r.length);n!=null&&(n.remove(),setShowNotification())},i+r.length*1e3)},setShowNotification=function(){for(var t=document.querySelectorAll(".notification"),n=0;n<t.length;n++)t[n].style.top=10+6*n+"%"},static_resource_path;
