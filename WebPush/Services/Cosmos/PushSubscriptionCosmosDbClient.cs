...
namespace WebPush.Services.Cosmos
{
    internal class PushSubscriptionCosmosDbClient : IPushSubscriptionCosmosDbClient
    {
        ...
        public Task AddAsync(WP.PushSubscription subscription)
        {
        ...
        public async Task<IEnumerable<WP.PushSubscription>> GetAllAsync()
        {
            List<WP.PushSubscription> listData = new List<WP.PushSubscription>();
